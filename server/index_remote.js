...
const server = new https.createServer({
  cert: fs.readFileSync('/etc/letsencrypt/live/collagekid.com/cert.pem'),
  key: fs.readFileSync('/etc/letsencrypt/live/collagekid.com/privkey.pem')
});
...
//https code from example

// const https = require('https');
//
// const privateKey = fs.readFileSync('/etc/letsencrypt/live/collagekid.com/privkey.pem', 'utf-8')
// const certificate = fs.readFileSync('/etc/letsencrypt/live/collagekid.com/cert.pem', 'utf-8')
//
...
//             .addInput(`${path}/final_video_narrated_audio.mp3`)
...
//             ffmpeg(`${path}/finalvideo_audio.mp3`)
//             .addInput(`${path}/narration_concat.mp4`)
//             .complexFilter('amix=inputs=2:duration=first:dropout_transition=3')
//             .save(`${path}/final_video_narrated_audio.mp3`)
//             .on('end', () => {
//                 mergeToVideo();
//             })
//             .on('error', (err) => (console.log('mix tracks error')));
//         }
//
//         ffmpeg(`${path_final}/finalvideo.mp4`)
//             .save(`${path}/finalvideo_audio.mp3`)
//             .on('end', () => {
//                 mixAudioTracks();
//             })
