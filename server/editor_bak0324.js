...
exports.concatMedia = () => {
        ...
        return new Promise((resolve, reject) => {
            ...
            return Promise.all(videoScaleHolder.map((cut, index) => cut(index)))
                .then((result) => {
                    ...
                    console.log('scaler wait message sent');
                    return resolve({
                        assets: result,
                        path: mediaFilePath
                    })
    ...
    var concatSounds = (ffmpeg, path) => {
        ...
        return new Promise((resolve, reject) => {
            ...
            spliceMedia(ffmpeg, path, soundConcatFull, 'sound', 'mp4', false, (success, info) => {
                if(success) {
    ...
    return new Promise((resolve, reject) => {
        ...
        const assembleAudioClips = (audioClips) => {
            ...
            return new Promise((resolve, reject) => {
                ...
                mergedMedia.mergeToFile(`${mediaFilePath}/assembledfullaudio.mp4`, './tmp/')
                    .fps(15)
                    .on('error', function(err) {
                        console.log('Error ' + err.message);
                        reject((err) => console.log('error', err));
                    ...
                    .on('end', function() {
                        resolve(`${mediaFilePath}/assembledfullaudio.mp4`);
                });
